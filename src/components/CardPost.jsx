            ...
            <div className="w-full bg-white rounded-lg border border-gray-300 p-4 hover:border-gray-400 hover:bg-gray-50">
                ...
                <div className="relative flex justify-between">
                    <div className="flex gap-2 items-center">
                        ...
                        <Link to={ data?.user_name ? `/user/${post.user_name}` : ''} className="flex gap-2 items-center" reloadDocument preventScrollReset>
                ...
                <Link to={`/post/${post.post_id}`} reloadDocument preventScrollReset>
                    <div className="pt-2">
